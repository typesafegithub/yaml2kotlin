...
import io.github.typesafegithub.workflows.actions.docker.SetupBuildxActionV1
...
public val workflowGeneratedSource: Workflow = workflow(
      ...
      sourceFile = Paths.get(".github/workflows/generated-source.main.kts"),
      env = linkedMapOf(
...
workflowGeneratedSource.writeToFile()