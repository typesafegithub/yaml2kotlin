...
fun usage(): Nothing {
    error(
        """|
           |Usage:
           |   ./gradlew :kotlin2yaml:cli:run --args /path/to/.github/workflows/build.yml
           |   ./gradlew :kotlin2yaml:cli:run --args https://raw.githubusercontent.com/krzema12/github-actions-kotlin-dsl/0f41e3322a3e7de4199000fae54b398380eace2f/.github/workflows/build.yaml
           |   ./gradlew :kotlin2yaml:cli:run --args https://gist.githubusercontent.com/jmfayard/dba8b5195292cac0e5f83c42de7cc3c2/raw/ca6143d70a8a34eea5ea64871f87cfec69443ab1/build.yml
        """.trimMargin(),
    )
}
